  ...
  useEffect(() => {
    const fetchSeochoData = async () => {
      try {
        ...
        // ⭐ 송파구만 받는 API
        const pollutionUrl = `https://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getMsrstnAcctoRltmMesureDnsty?stationName=송파구&dataTerm=daily&pageNo=1&numOfRows=1&returnType=json&ver=1.3&serviceKey=${AIR_KOREA_KEY}`;
